...
Human admin login is separate and uses configured login providers such as a
GitHub OAuth App for bare deployments or OIDC for enterprise SSO.
...
- `08-security-observability-operations.md` - secret safety, redaction,
  telemetry, storage, deployment, and incident operations.
...
- `11-login-user-management.md` - GitHub OAuth App login, OIDC login,
  ...
  management.
- `12-dashboards-observability-api.md` - dashboards, usage analytics, model
